...
| 方舟 | 产品经理 | `Product-Manager-Skills` | `workspaces/agents/product_manager/skills/Product-Manager-Skills/` | `https://github.com/deanpeters/Product-Manager-Skills`，commit `9971018` | CC BY-NC-SA 4.0，已安装 |
