...
# 函数「_check_source」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「classify_stock」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「to_yfinance_code」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「_df_to_ohlcv」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「_fetch_tushare_a」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「_fetch_efinance_a」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「_fetch_efinance_hk」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「_fetch_akshare_a」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「_fetch_akshare_hk」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「_fetch_yfinance」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「_fetch_realtime_a」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「_fetch_realtime_hk」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「_fetch_realtime_us」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「fetch_cn_a」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「fetch_hk」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「fetch_us」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「search_news」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「_safe_float」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「calc_ema」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「calc_ma」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「calc_macd」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「calc_rsi」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「calc_volume_analysis」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「calc_bias」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「calc_support」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「calc_trend_score」负责完成该步骤的输入处理、核心逻辑和结果返回。
...
# 函数「analyze_stock」负责完成该步骤的输入处理、核心逻辑和结果返回。
